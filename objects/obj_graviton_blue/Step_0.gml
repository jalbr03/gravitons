left = gamepad_axis_value(selectManager.Blueis,gp_axislh) < 0;
right = gamepad_axis_value(selectManager.Blueis,gp_axislh) > 0;
SWgravity = gamepad_button_check_pressed(selectManager.Blueis,gp_face1);
