...
if(asigned == false && obj_player_select3.asigned == true){
...
if(asigned == true){
	...
	if(selectManager.P2chose != playerselect && selectManager.P3chose != playerselect && selectManager.P1chose != playerselect){
		image_index = playerselect-1;
		if(select){
			selectManager.P4chose = playerselect;
		}
	}
	if(selectManager.P2chose == playerselect || selectManager.P3chose == playerselect || selectManager.P1chose == playerselect){
