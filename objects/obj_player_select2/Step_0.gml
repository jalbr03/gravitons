...
if(asigned == false && obj_player_select1.asigned == true){
...
if(asigned == true){
	...
	if(selectManager.P1chose != playerselect && selectManager.P3chose != playerselect && selectManager.P4chose != playerselect){
		image_index = playerselect-1;
		if(select){
			selectManager.P2chose = playerselect;
		}
	}
	if(selectManager.P1chose == playerselect || selectManager.P3chose == playerselect || selectManager.P4chose == playerselect){
