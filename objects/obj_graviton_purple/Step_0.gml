left = gamepad_axis_value(selectManager.Purpleis,gp_axislh) < 0;
right = gamepad_axis_value(selectManager.Purpleis,gp_axislh) > 0;
SWgravity = gamepad_button_check_pressed(selectManager.Purpleis,gp_face1);
